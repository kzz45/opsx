      ...
      >
        ...
        <el-row>
          <el-col :span="12">
            ...
            >
              <el-input
                v-model="factory_form.access_id"
                size="small"
              ></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            ...
            >
              <el-input
                v-model="factory_form.access_key"
                size="small"
              ></el-input>
            </el-form-item>
          </el-col>
...
import {
  ...
  getFactoryList,
  updateFactory
} from "@/views/container/apis/factory"
import { createGitlab, getGitlabList, updateGitlab } from "@/views/container/apis/gitlab"
import {
  createGroup,
  getGroupList,
  updateGroup
} from "@/views/container/apis/group"
import {
  createJenkins,
  getJenkinsList,
  updateJenkins
} from "@/views/container/apis/jenkins"
import { getPermList } from "@/views/container/apis/perm"
import {
  createProduct,
  getProductList,
  updateProduct
} from "@/views/container/apis/product"
import {
  createProject,
  getProjectList,
  updateProject
} from "@/views/container/apis/project"
import {
  createUser,
  deleteUser,
  getUserList,
  updateUser
} from "@/views/container/apis/user"
import {
  createUserGroup,
  getUserGroupList,
  updateUserGroup
} from "@/views/container/apis/user_group"
      ...
      if (this.dialog_status === "create_factory") {
        createFactory(this.factory_form)
          .then((resp) => {
            this.$message({
              type: "success",
              message: "新增云厂【" + this.factory_form.name + "】成功"
            })
        ...
        updateFactory(this.factory_form.id, this.factory_form)
          .then(() => {
            this.$message({
              type: "success",
              message: "更新云厂【" + this.factory_form.name + "】成功"
            })
            this.factory_dialog = false
            this.get_factory_list()
          })
